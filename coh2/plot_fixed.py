...
coh2c_stw_e = np.loadtxt("./Data/coh2c_stw_e.dat", dtype=None)
coh2c_stw_pe = np.loadtxt("./Data/coh2c_stw_pe.dat", dtype=None)
coh2c_stw_pp = np.loadtxt("./Data/coh2c_stw_pp.dat", dtype=None)
...
coh2c_stw_iter = np.arange(1,coh2c_stw_e.size,1)
...
ax[0].plot(coh2c_stw_iter,coh2c_stw_e[1:],'o-',c='y',ms=2,label="Stepwise-DIIS-Gau")
...
ax[1].plot(coh2c_stw_iter,coh2c_stw_pe[1:],'o-',c='y',ms=2)
...
ax[2].plot(coh2c_stw_iter,coh2c_stw_pp[1:],'o-',c='y',ms=2)
...
plt.tight_layout()
plt.savefig('../plots/coh2_qc_vs_gau_fixed.pdf', dpi=3600)
